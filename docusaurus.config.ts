...
const config: Config = {
  title: 'Escuela de derechos v2.0',
  ...
  url: 'https://chaemendoza.github.io',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Escuela Docs. Defensoría del pueblo del Ecuador.`,
    },
    prism: {
